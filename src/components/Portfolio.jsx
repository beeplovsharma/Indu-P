          ...
          {portfolios.map(({ id, src }) => (
            <div key={id} className="h-[250px] w-[300px]  rounded-md shadow-lg shadow-slate-600 flex flex-col justify-center items-center gap-2">
              ...
              <div className="flex justify-center items-center gap-2">
                <button className="text-white bg-gradient-to-r from-gray-700 t-black px-3 py-2 rounded-md">
                  Demo
                </button>
                <button className="text-white bg-gradient-to-l from-gray-700 t-black px-3 py-2 rounded-md">
                  Code
                </button>
              </div>
            </div>
